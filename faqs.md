...
Yes, you can. To open the Usage Dashboard page, in the {{site.data.keyword.cloud}} console, go to **Manage** &gt; **Billing and usage**. Select **Usage** to view a summary of the usage by resource group for the account. 
